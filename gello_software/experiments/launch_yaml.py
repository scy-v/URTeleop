...
def main():
    ...
    if bimanual:
        move_to_start_position(env, robot, bimanual, left_cfg, right_cfg)
    else:
        move_to_start_position(env, robot, bimanual, left_cfg)
    ...
    run_control_loop(env, agent, robot, save_interface)
